...
@NgModule({
  declarations: [LoginComponent, LayoutUserComponent, NewAgreementComponent, RequestLCComponent, Option1Component, ManageTransactionsComponent, ListNewRequestComponent, DetailAgreementComponent, ListRequestLcComponent, ListAgreementComponent],
  imports: [
    NzUploadModule,
    NzRadioModule,
    NzBreadCrumbModule,
